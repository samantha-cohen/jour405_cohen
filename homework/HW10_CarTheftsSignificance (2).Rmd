...
**My initial reaction to the change in car thefts is how much it has declined over the past two years, especially the most recent data point for 2025. There seems to be an overall downward, decreasing trend of car thefts, with peaks at the end of 2023 and midway through 2024.**
...
- What does the 95% confidence interval show here? **We can be 95% confident that that the true mean number of car thefts per month is around 460.4, between about 420 and 510.  **

- What figure(s) accurately reflects the number of car thefts in a typical month? **460.4 with a range from about 420 to 510, based on the part shaded on the graph.:**

- Propose a headline about the trend in car thefts that is focused on the present and future, but informed by the data you see above. **Decline in car thefts since 2023, expected to drop by end of 2025**
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **Since the p-value = 0.1791, which is greater than .05, we do not reject the null hypothesis and therefore, there is no statistically significant difference in the average number of car thefts between the first and second half.   **

How would you revise your headline from Task 6, if at all? What would you tell your editor, and what would you expect her to ask you? **I could change it so that it seems less of a steady trend, and more so variable and have the possibility to change. Since there isn't enough statistically significant evidence to prove the two periods are different, we can't make the headline seem like it's a steady trend. **
