...
**Education levels in survey samples often differ from the general population because those who are more educated are probably more likely to participate in surveys. Depending on where you take the survey from, as in region or area, this could impact certain education groups to be over or underrepresented. **
...
**Over 90% of voters have a college education**
...
**The percentages didn't change too much after adding in the weight factor. The college category barely changed and neither did the some college category. The high school or less category changed the most with the yes % going from 73.5% to 70.8%. **

2. Why might the weighted results be considered more accurate than the unweighted results?

**The weighted results might be considered more accurate because they better reflect the true characteristics of a population, taking in certain factors that wouldn't be represented without weighting it.**
...
**High school or less -- yes % category.**
...
**It's important for journalists to understand survey weighting when reporting on polls to give their audience a truly accurate representation, incorporating all factors necessary to paint a clear picture.**

2. How might the differences between weighted and unweighted results affect how you would report on this data?

**If you have data for both, I think it would be useful to include both, or if you want to be clear for the audience, it would be best to report on the weighted data since it's more accurate.  **
...
**I would want to know what environmental factors are taken into account or how it's adjusted to make sense for the population sample it's taken from. It's important for the audience to have a disclaimer on how it's calculated too. **
