...
Pre-spike the mean thefts were 216.9 while post-spike, more than doubles to 573.4 in 2023, and slightly decreased to 418.79, suggesting that the spike in car theft rates in 2023 in Prince George's County has continued to have a huge impact in car thefts in the area. 
...
**There's a steady car theft rate, with slight increases and decreases, between 2018 and 2022, staying within the 20-30 range and then peaks in 2023, to over 60, then sharply decreases until 2025. A new title could be "2023 spike year changes 8-year monthly car theft pattern for PG County."**
...
- **Null Hypothesis (H0)**:   There is no significant difference in car theft rates between the pre-spike period (before 2023), the spike year (2023), and the post-spike period (after 2023)
- **Alternative Hypothesis (H1)**: There is a significant difference in car theft rates between the pre-spike period (before 2023), the spike year (2023), and the post-spike period (after 2023)
...
**Since the p-value is 2e-16, it is way less than 0.001, therefore we can reject the null hypothesis and prove that the results are significant, showing that there is a significant difference in car theft rates between the pre-spike period (before 2023), the spike year (2023), and the post-spike period (after 2023). **
...
**The results of the Tukey's test and chart are very telling. The biggest, most significant difference among the three period is for Spike year-Pre-spike with a difference of 36.76. In fact, the car theft rates are significantly different between Pre-spike, Spike year, and Post-spike since none of the confidence intervals even include the number 0.**

**Prince George's County still recovering from car thefts spike in 2023 **

**In 2023, Prince George's County saw a massive spike in their car thefts rising from about an average of 217 per month before 2023, to about 573 per month in 2023. Since then, there's been a slight decrease, but the rates are still not as low as pre-spike numbers. According to an ANOVA test, statistics prove that there is a significant difference in car theft rates between the pre-spike period (before 2023), the spike year (2023), and the post-spike period (after 2023), since the p-value is 2e-16, it is way less than 0.001.**