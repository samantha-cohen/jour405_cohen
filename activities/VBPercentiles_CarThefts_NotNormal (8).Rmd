...
An example of data that isn't normally distributed would be survey basketball skill levels since the taller you are, the more likely you are to be better at basketball than a shorter person surveyed. Also, if you were to take a random sample of people's salaries, that wouldn't be normally distributed if you have a teenager and an adult in the same sample. 

A reporter working on a story about data that isn't normally distributed should describe that data by saying it wasn't a fully representative sample. It's always best to be candid and honest with results. 
...
**Answer**:
Maryland has 223 total aces and	is in the 95th percentile. This puts them in 17th place when counting up all the other colleges, the colleges in the top 3, all in the 100th percentile includes UTEP, Sacramento St. and Mercer. 
...
Skewed left-- this means the median > mean. Most of the data falls within the range from about 8 to 17.5.
