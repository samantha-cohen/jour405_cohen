...
**There is a weak positive correlation between FARMS percentage and math test scores as indicated by the line. **
...
**Based on what we've learned so far, we can see the p-value isn't significant since it is 0.1225 nor is the adjusted r-squared. There is an insignificant relationship between the two values therefore this model won't accurately predict whether or not the two values are related.**
...
**The schools with the largest differences between the predicted result and the actual math scores are Whitemarsh, Gulph, Crooked Billet and Lower Gwynedd with absolute residuals greater than 30. **
...
**This conclusion is false and cannot be proven according to our model's results. The p-value of 0.1225 is not significant, the adjusted r-squared of 0.0254 is not significant and the model has a weak positive correlation. A pitch about this relationship would be to describe how the there isn't a strong relationship between the FARMS (Free and Reduced-price Meal System) percentage and the percentage of students who met or exceeded math expectations.**