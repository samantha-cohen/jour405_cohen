...
**This data shows total populations of MD cities, which have more than two races, plus all other races the cities have. Baltimore City is predominantly Black and the most diverse. Other diverse cities include Germantown and Columbia. **
...
**Summerfield has the highest race probability of 0.87, which makes sense since their Black percentage is 0.93, indicating that majority if their population is Black. This checks out with the data that if you were to randomly select two people from Summerfield, they would both be Black.**
...
**Chillum and East Riverdale have the lowest Hisp_Prob scores and relatively low Hispanic populations as well as low race probability, indicating high diversity.**
...
**The top three cities which are the most diverse include Langley Park (97.18), Wheaton (90.88) and Adelphi (90.04). Langley Park and Adelphi are located in PG County while Wheaton is located in Montgomery County. The least diverse city is in Lake Shore with a diversity index of 15.5 which is in Anne Arundel County.**
...
**Prince George's County holds two of the most diverse cities in Maryland**

**Out of the three most diverse cities in Maryland, Langley Park, Wheaton and Adelphi, two of those are located in Prince George's County. Langley Park and Adelphi have diversity index scores in the 90% range. The closer to 100%, the more diverse.**

**I would talk to Census staff, potential the mayors' offices of each of these cities and ask them questions about why they think they attract the most diverse communities. What makes their cities special and unique? Has this always been a trend for your city? **
