...
52% support, sample size 100: 10% 
53% support, sample size 800: 3.54%
55% support, sample size 400: 5%
...
1. No, this is not statistically justified since the margin of error for all three of them ranges to be either less than 50% are in support to greater than 50% are in support, so we can't assume that the majority is in support. 

2.   "Around half supports new city policy" 
...
Officials claims about the construction of a transit line increasing local property prices is now supported by data. 

The original average price of homes in the area before the transit line was $285,000 and now after the input of the transit line, the average price of homes has risen to $304,500. A statistical test found that this connection is highly probable. 
