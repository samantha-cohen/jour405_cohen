...
**Task 3: The mean SAT score for private colleges is the highest of the three, followed by public, then community college. The mean difference between public and private schools isn't extremely far apart, while the mean difference for community college and private and public is large. Private colleges have the smallest standard deviation, while community colleges have the largest. 
**
...
1. Yes, as the Tukey HSD test shows, there is a significant difference in SAT scores across college types. 
2. Public and private colleges differ the most from each other by about 74 points. 
3. Between private and community colleges, the difference is about 367 points while for public and community colleges, the difference is about 293 points. 
