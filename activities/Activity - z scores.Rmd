...
**The number of calls are higher in the summer slightly than in the winter. There is a slight dip was we get to December and January while there are still some spikes in the fall and winter. **
...
**While we can see somewhat of a trend from the graph in Task 3, indicating higher call numbers in the summer than winter, the unusually high days highlighted in the graph below are spread throughout several months with one of the highest days being in the fall, in October. Most of the unusually high points were in summer, but we can still see some in the winter. There was a greater spread throughout.**
...
**Saturdays has the highest average number of calls of 11.3, which is slightly higher than Friday's average of 11. The weekend overall has higher averages than weekdays, which makes sense since more people are out and about during the weekends, making it more likely for 911-related accidents to occur.**
...
**Based on our z-score analysis, potential angles for reporting include the summer months being prime time for 911 calls for overdoses, as well as the weekends, specifically Saturday, having more 911 calls. I would tell an editor that we can connect time of year with the time of week in which most people are out and about, which makes sense. The warmer weather in the summer alongside the weekends when people aren't as busy as the weeks, it all makes sense as to when we see the most 911 call activity.**
