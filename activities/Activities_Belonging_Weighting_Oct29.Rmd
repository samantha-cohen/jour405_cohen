...
We had concerns about the following statements made in the appendix: 

1. Respondents that identified as Alaska Native, American Indian/Native American/Indigenous, Levantine/Middle Eastern/Southwest Asian/North African (SWANA), Native Hawaiian, Pacific Islander, and Jewish were grouped into “Races/Ethnicities with Small Sample Sizes."
2. Those who indicated they were genderfluid, non-binary, transgender, and/or wrote in another gender identity were grouped into the analysis category “Gender Expansive.”
3. Estimates based on < 5 responses were redacted (-) to protect respondent confidentiality.

Without closely looking into the data, someone could draw inaccurate conclusions about the data. Some of these decisions alter and regroup dissimilar data together which isn't the correct way to determine the final outcomes. The choice to redact certain small population shows that it's noteworthy when considering outliers. 
...
1. What is the range of weights in this dataset? **the range = 0.23 to 3.04:**

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **When a respondent has a weight of 0.23, that means that they're the minimum in the dataset while 3.04 is the maximum in the data set. 0.23 means a fourth of a respondent counts as a person while 3.04 means three respondents counts as one person.**

3. Why might some respondents be weighted more heavily than others? **Some respondent populations are more likely to respond than others due to a variety of different factors. Those will appear more frequently in the data than other populations.:**
...
1. Which voter category shows the biggest difference between weighted and unweighted results? **the rarely/never voter category had a % point difference of -3.56013712**

2. How might these differences affect reporting on likely voter turnout? **There would likely be no change to the likely voter turnout, as the always and sporadic data showed no significant change whereas the rarely/never category had more significant change. **

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? **The rarely/never voters are overrepresented since they had the biggest differences between the weighted and unweighted categories. These differences exist because people who are less likely to go out and vote are also likely not as inclined to respond to polls, which makes sense why the data would be overrepresented for that category.**
