...
*This is a useful model because it shows over half of the variation in wins and the f-statistic proves to be significant and meaningful in this context. The model shows us  which factors influence winning the most.*
...
*Points scored had the strongest impact on wins as we can see a strong positive significant correlation. Also, teams which score more points are correlated to more wins. Takeways aren't as strongly correlated as the other categories but there is still some correlation. Lastly, yards gained doesn't appear to have much of an effect on wins in this data.*

## Using the Model

Without using the words "multiple regression model", describe how you could use this model to cover a team or game.

*This model could be used to point out which statistics help a team win. This could explain how teams that score more points tend to win more games. This could be a good tool to track how certain teams are doing throughout the season. *
